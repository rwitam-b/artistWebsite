...
<body>
    <header>
        <div class="greet">
            <img class="img-responsive animated zoomInDown" src="images/logo-white.png">
        </div>
    </header>
    <section id="story">
        <div class="row wow fadeInRight">
            <div class="col-sm-6 text-center">
                <img class="img-responsive" src="images/me.jpg" style="width:50vw;">
            </div>
            <div class="col-sm-6 text-justify">
                <br><br>
                <h2 class="heading animated infinite pulse">My Story</h2>
    ...
    <section id="work">
      <iframe id="soundcloudFrame" class="wow lightSpeedIn" data-wow-delay="2s" width="100%" height="450" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/users/31383641&amp;color=ff5500&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=true"></iframe>
    </section>
